const Education = () => {
  return (
    <div
      name="education"
      className="h-screen w-full bg-gradient-to-b from-gray-800 via-gray to-black text-white py-8  content-center"
      id="aboutme"
    >
      ...
      <div className=" flex justify-center items-center z-1">
        <div className="max-w-6xl mx-auto w-full grid grid-cols-9 px-2">
          ...
          <div className=" col-span-1 w-full h-full flex justify-center items-center">
            <div className="h-full w-1 bg-indigo-400 text-white">
              <div className="mt-10 -ml-3 w-8 h-8 rounded-full bg-gradient-to-b from-gray-800 to-black text-white  text-sm pt-1">
                2022
              </div>
            </div>
          </div>
          ...
          <div className=" col-span-1 w-full h-full flex justify-center items-center">
            <div className="h-full w-1 bg-indigo-400 text-white">
              <div className="mt-10 -ml-3 w-8 h-8 rounded-full bg-gradient-to-b from-gray-800 to-black text-white text-sm text-center pt-1">
                2018
              </div>
            </div>
          </div>
          ...
          <div className=" col-span-1 w-full h-full flex justify-center items-center">
            <div className="h-full w-1 bg-indigo-400 text-white">
              <div className="mt-10 -ml-3 w-8 h-8 rounded-full bg-gradient-to-b from-black to-gray-800 text-white text-center text-sm pt-1">
                2015
              </div>
            </div>
          </div>
