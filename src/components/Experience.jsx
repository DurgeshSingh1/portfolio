const Experience = () => {
  return (
    <div
      name="experience"
      className="h-screen w-screen bg-gradient-to-b from-black via-gray to-gray-800 text-white py-8 content-center"
      id="aboutme"
    >
        ...
        <div className="max-w-6xl mx-auto w-full grid grid-cols-9 px-2">
          ...
          <div className=" col-span-1 w-full h-full flex justify-center items-center">
            <div className="h-full w-1 bg-indigo-400 text-white">
              <div className=" w-8 h-8 mt-10 -ml-3 rounded-full bg-gradient-to-b from-gray-800 to-black text-white text-center text-sm pt-1">
                2022
              </div>
            </div>
          </div>
